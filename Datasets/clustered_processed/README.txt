...
./clusters/screennames/ -> each cluster file with screenname
./clusters/text/ -> each cluster file with accumulated text per cluster
./sentiments/clusters/ -> screenname, polarity, subjectivity
./sentiments/topics/ -> screenname, polarity, subjectivity
./stats/sourceslist -> source list, count list (in same order)
./stats/urls -> url, count
./stats/userengagements -> screen_name, user_statuses, user_tweets, user_retweets, user_favourites, user_replies_and_mentions, likes_per_tweet, retweets_per_tweet, lists_account_age_ratio, follower_friend_ratio, lifetime_statuses_freq, favourite_tweet_ratio, age_of_account_in_days, sources_count, urls_count, daily_favouriting_frequency
...
@inproceedings{Gilani:2017:BH:3110025.3110090,
 ...
 pages = {349--354},
 numpages = {6},
 url = {http://doi.acm.org/10.1145/3110025.3110090},
